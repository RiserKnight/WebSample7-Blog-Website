...
app.post("/compose", function(req, res){
  ...
  let userNewTitle =req.body.postTitle;
  userNewTitle = _.lowerCase(userNewTitle);
  const newTitle = _.capitalize(userNewTitle);
...
app.get("/posts/:postName", function(req, res){
  let rawRequestedTitle = _.lowerCase(req.params.postName);
const requestedTitle = _.capitalize(rawRequestedTitle);
